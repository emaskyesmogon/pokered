...
; Characteristics of each move.
	...
	move DOUBLESLAP,   TWO_TO_FIVE_ATTACKS_EFFECT,  20, NORMAL,        85, 15
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  20, COSMIC,        85, 15
	move MEGA_PUNCH,   NO_ADDITIONAL_EFFECT,        90, NORMAL,       100, 20
	...
	move GUILLOTINE,   RECOIL_EFFECT,               90, BUG,           90, 10
	...
	move WHIRLWIND,    NO_ADDITIONAL_EFFECT,       110, FLYING,        85, 20
	move FLY,          PARALYZE_SIDE_EFFECT2,       70, FLYING,        95, 15
	move BIND,         TRAPPING_EFFECT,             35, NORMAL,        85,  5
	move SLAM,         NO_ADDITIONAL_EFFECT,        80, FIGHTING,      90, 20
	move VINE_WHIP,    NO_ADDITIONAL_EFFECT,        35, GRASS,        100, 10
	move STOMP,        FLINCH_SIDE_EFFECT2,         65, FERAL,        100, 20
	move DOUBLE_KICK,  ATTACK_TWICE_EFFECT,         30, FIGHTING,     100, 30
	move MEGA_KICK,    NO_ADDITIONAL_EFFECT,       120, NORMAL,        80,  5
	move JUMP_KICK,    JUMP_KICK_EFFECT,            90, FIGHTING,      95, 25
	move ROLLING_KICK, FLINCH_SIDE_EFFECT2,         70, FIGHTING,      85, 15
	move SAND_ATTACK,  ACCURACY_DOWN1_EFFECT,        0, GROUND,       100, 15
	move HEADBUTT,     FLINCH_SIDE_EFFECT2,         70, NORMAL,       100, 15
	move HORN_ATTACK,  NO_ADDITIONAL_EFFECT,        65, NORMAL,       100, 25
	move FURY_ATTACK,  TWO_TO_FIVE_ATTACKS_EFFECT,  25, FERAL,         85, 20
	move HORN_DRILL,   NO_ADDITIONAL_EFFECT,        60, GROUND,        90, 10
	...
	move THRASH,       THRASH_PETAL_DANCE_EFFECT,  120, DRAGON,       100,  5
	move DOUBLE_EDGE,  RECOIL_EFFECT,              100, NORMAL,       100, 15
	move TAIL_WHIP,    DEFENSE_DOWN1_EFFECT,         0, NORMAL,       100, 30
	move POISON_STING, POISON_SIDE_EFFECT2,         80, POISON,       100, 15
	...
	move ROAR,         CONFUSION_SIDE_EFFECT,       60, FERAL,        100, 20
	move SING,         SLEEP_EFFECT,                 0, NORMAL,        55, 15
	move SUPERSONIC,   CONFUSION_EFFECT,             0, NORMAL,        90, 20
	move SONICBOOM,    PARALYZE_EFFECT,             20, ELECTRIC,      90, 20
	move DISABLE,      DISABLE_EFFECT,               0, NORMAL,        95, 20
	move ACID,         DEFENSE_DOWN_SIDE_EFFECT,    70, FOOD,         100, 30
	...
	move STRENGTH,     NO_ADDITIONAL_EFFECT,        95, FERAL,        100, 15
	...
	move SOLARBEAM,    BURN_SIDE_EFFECT2,           120, GRASS,        85, 10
	move POISONPOWDER, POISON_EFFECT,                0, POISON,        75, 35
	move STUN_SPORE,   PARALYZE_EFFECT,              0, GRASS,         75, 30
	move SLEEP_POWDER, SLEEP_EFFECT,                 0, GRASS,         75, 15
	move PETAL_DANCE,  THRASH_PETAL_DANCE_EFFECT,  120, GRASS,        100, 20
	move STRING_SHOT,  SPEED_DOWN1_EFFECT,           0, BUG,           95, 40
	move DRAGON_RAGE,  PARALYZE_SIDE_EFFECT2,       60, DRAGON,       100, 10
	move FIRE_SPIN,    TRAPPING_EFFECT,             35, FIRE,          86,  5
	...
	move FISSURE,      SPEED_DOWN1_EFFECT,          80, GROUND,       100, 15
	move DIG,          RECOIL_EFFECT,              100, GROUND,       100, 10
	move TOXIC,        POISON_EFFECT,               30, POISON,       100, 10
	...
	move RAGE,         NO_ADDITIONAL_EFFECT,        60, FERAL,        100, 20
	move TELEPORT,     HEAL_EFFECT,                  0, COSMIC,       100,  5
	move NIGHT_SHADE,  SPECIAL_DAMAGE_EFFECT,        0, GHOST,        100, 15
	move MIMIC,        MIMIC_EFFECT,                 0, NORMAL,       100, 10
	move SCREECH,      DEFENSE_DOWN2_EFFECT,         0, NORMAL,        85, 40
	move DOUBLE_TEAM,  SPEED_UP1_EFFECT,             0, NORMAL,       100, 15
	move RECOVER,      HEAL_EFFECT,                  0, NORMAL,       100, 10
	move HARDEN,       DEFENSE_UP1_EFFECT,           0, NORMAL,       100, 30
	move MINIMIZE,     DEFENSE_UP2_EFFECT,           0, COSMIC,       100, 20
	...
	move EGG_BOMB,     BURN_SIDE_EFFECT2,          100, FOOD,          75, 10
	...
	move BONE_CLUB,    FLINCH_SIDE_EFFECT1,         65, FERAL,         85, 20
	move FIRE_BLAST,   BURN_SIDE_EFFECT2,          120, FIRE,          85,  5
	move WATERFALL,    NO_ADDITIONAL_EFFECT,        80, WATER,        100, 15
	move CLAMP,        TRAPPING_EFFECT,             35, WATER,         85,  5
	move SWIFT,        SWIFT_EFFECT,                60, COSMIC,       100, 20
	move SKULL_BASH,   NO_ADDITIONAL_EFFECT,       100, FERAL,        100, 15
	...
	move SOFTBOILED,   HEAL_EFFECT,                  0, FOOD,         100, 10
	...
	move BARRAGE,      ATTACK_TWICE_EFFECT,         40, FOOD,          95, 20
	move LEECH_LIFE,   DRAIN_HP_EFFECT,             60, BUG,          100, 15
	move LOVELY_KISS,  SLEEP_EFFECT,                 0, NORMAL,        75, 10
	move SKY_ATTACK,   RECOIL_EFFECT,               90, FLYING,        90, 15
	...
	move FURY_SWIPES,  ATTACK_TWICE_EFFECT,         40, FERAL,         80, 15
	move BONEMERANG,   ATTACK_TWICE_EFFECT,         50, FERAL,         90, 10
	...
	move TRI_ATTACK,   NO_ADDITIONAL_EFFECT,        80, COSMIC,       100, 10
